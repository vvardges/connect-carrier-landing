  ...
  return (
    <>
      ...
      <div className="bg-gray-2 dark:bg-dark-3">
        ...
        <p className="px-[20px] mx-auto max-w-[780px] text-base font-medium sm:text-lg sm:leading-[1.44] flex justify-center items-center text-gray-800 dark:text-dark-6">
